...
public class MemberDao {
	...
	public int insertImage(Connection conn, String imageRoute) {
		int result = 0;
		PreparedStatement pstmt = null;
		
		String query = "insert into image_collection values (sq_imageid.nextval, ?)";
		
		try {
			pstmt = conn.prepareStatement(query);
			pstmt.setString(1, imageRoute);
